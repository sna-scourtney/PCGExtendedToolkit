...
/**
 * Visualizer for FPCGExConstraint_Probability.
 * Draws a dice/percentage indicator near the connector.
 */
class PCGEXELEMENTSVALENCYEDITOR_API FProbabilityVisualizer : public IConstraintVisualizer
{
public:
