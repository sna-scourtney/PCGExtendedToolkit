...
/**
 * Visualizer for FPCGExConstraint_Lattice.
 * Draws a grid of dots on the connector face plane.
 */
class PCGEXELEMENTSVALENCYEDITOR_API FLatticeVisualizer : public IConstraintVisualizer
{
public:
