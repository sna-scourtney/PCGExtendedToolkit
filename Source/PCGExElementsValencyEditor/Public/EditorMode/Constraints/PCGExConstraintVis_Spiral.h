...
/**
 * Visualizer for FPCGExConstraint_Spiral.
 * Draws a helix wireframe showing the spiral placement path.
 */
class PCGEXELEMENTSVALENCYEDITOR_API FSpiralVisualizer : public IConstraintVisualizer
{
public:
