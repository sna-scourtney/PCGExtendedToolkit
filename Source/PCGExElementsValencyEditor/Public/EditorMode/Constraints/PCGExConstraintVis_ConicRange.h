...
/**
 * Visualizer for FPCGExConstraint_ConicRange.
 * Draws a cone wireframe showing the aperture angle and step positions.
 */
class PCGEXELEMENTSVALENCYEDITOR_API FConicRangeVisualizer : public IConstraintVisualizer
{
public:
