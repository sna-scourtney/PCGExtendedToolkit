...
/**
 * Visualizer for FPCGExConstraint_ArcSurface.
 * Draws the arc-shaped area on the connector face (inner/outer arcs + radial lines).
 */
class PCGEXELEMENTSVALENCYEDITOR_API FArcSurfaceVisualizer : public IConstraintVisualizer
{
public:
