...
/**
 * Visualizer for FPCGExConstraint_AlignToWorld.
 * Draws an arrow showing the alignment target direction.
 */
class PCGEXELEMENTSVALENCYEDITOR_API FAlignToWorldVisualizer : public IConstraintVisualizer
{
public:
